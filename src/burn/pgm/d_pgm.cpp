...
static struct BurnRomInfo orlegendRomDesc[] = {
	{ "p0103.rom",     0x200000, 0xd5e93543, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0100.rom",     0x400000, 0x61425e1e, 2 | BRF_GRA },		  // Tile data

	{ "a0100.rom",     0x400000, 0x8b3bd88a, 3 | BRF_GRA },		  // Sprite Color Data
	...
	{ "b0100.rom",     0x400000, 0x69d2e48c, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
	{ "b0101.rom",     0x400000, 0x0d587bf3, 4 | BRF_GRA },
	{ "b0102.rom",     0x400000, 0x43823c1e, 4 | BRF_GRA },

	{ "m0100.rom",     0x200000, 0xe5c36c83, 5 | BRF_SND },		  // Samples
};
...
static struct BurnRomInfo orlegndeRomDesc[] = {
	{ "p0102.rom",     0x200000, 0x4d0f6cc5, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo orlegndcRomDesc[] = {
	{ "p0101.160",     0x200000, 0xb24f0c1e, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo orld111cRomDesc[] = {
	{ "olv111ch.u6",   0x080000, 0x5fb86373, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo orld105kRomDesc[] = {
	{ "olv105ko.u6",   0x080000, 0xb86703fe, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo drgw2RomDesc[] = {
	{ "v-110x.u2",     0x080000, 0x1978106b, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "pgmt0200.u7",   0x400000, 0xb0f6534d, 2 | BRF_GRA },		  // Tile data

	{ "pgma0200.u5",   0x400000, 0x13b95069, 3 | BRF_GRA },		  // Sprite Color Data

	{ "pgmb0200.u9",   0x400000, 0x932d0f13, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
};
...
struct BurnDriver BurnDrvDrgw2 = {
	"drgw2", NULL, "pgm", "1997",
	"Dragon World II (V110X, Export)\0", NULL, "IGS", "PGM",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo drgw2cRomDesc[] = {
	{ "v-100c.u2",     0x080000, 0x67467981, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo drgw2jRomDesc[] = {
	{ "v-100j.u2",     	  0x080000, 0xf8f8393e, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
struct BurnDriver BurnDrvDrgw2j = {
	...
	"Chuugokuryuu II (V100J, Japan)\0", NULL, "IGS", "PGM",
...
static struct BurnRomInfo killbldRomDesc[] = {
	{ "kb_u3_v104.u3", 0x080000, 0x6db1d719, 1 | BRF_ESS | BRF_PRG }, // 68K Code
	{ "kb_u6_v104.u6", 0x080000, 0x31ecc978, 1 | BRF_ESS | BRF_PRG },
	{ "kb_u4_v104.u4", 0x080000, 0x1ed8b2e7, 1 | BRF_ESS | BRF_PRG },
	{ "kb_u5_v104.u5", 0x080000, 0xa0bafc29, 1 | BRF_ESS | BRF_PRG },

	{ "t0300.u14",	   0x400000, 0x0922f7d9, 2 | BRF_GRA },		  // Tile data

	{ "a0300.u9",      0x400000, 0x3f9455d3, 3 | BRF_GRA },		  // Sprite Color Data
	...
	{ "b0300.u13",	   0x400000, 0x7f876981, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
	{ "b0302.u14",	   0x400000, 0xeea9c502, 4 | BRF_GRA },
	{ "b0303.u15",	   0x200000, 0x77a9652e, 4 | BRF_GRA },

	{ "m0300.u1",      0x400000, 0x93159695, 5 | BRF_SND },		  // Samples
...
static struct BurnRomInfo killbldtRomDesc[] = {
	{ "kb.u9",         0x200000, 0x43da77d7, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
struct BurnDriverD BurnDrvDrgw3 = {
	...
	L"Dragon World 3\0\u4E2D\u56FD\u9F99 3 (V100J)\0", NULL, NULL, NULL,
...
static struct BurnRomInfo oldsRomDesc[] = {
	{ "sp_v101.u2",		  0x080000, 0x08eb9661, 1 | BRF_ESS | BRF_PRG }, // 68K Code
	...
	{ "a0500.rom",		  0x400000, 0x80a59197, 3 | BRF_GRA },		 // Sprite Color Data
	...
	{ "b0500.rom",		  0x400000, 0xcde07f74, 4 | BRF_GRA },		 // Sprite Masks & Color Indexes
...
struct BurnDriverD BurnDrvOlds = {
	...
	L"Oriental Legend Special\0\u897F\u6E38\u91CA\u5384\u4F20 Special (V101, Korea)\0", NULL, NULL, NULL,
	0, 4, HARDWARE_IGS_PGM, GBF_SCRFIGHT, 0,
...
static struct BurnRomInfo olds100RomDesc[] = {
	{ "v100-u2.040",	  0x080000, 0x517c2a06, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo olds100aRomDesc[] = {
	...
	{ "protection_data.u6",	  0x010000, 0, 		0 | BRF_NODUMP | BRF_PRG }, // protection rom
...
static struct BurnRomInfo photoy2kRomDesc[] = {
	{ "v104.16m",      0x200000, 0xe051070f, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0700.rom",     0x080000, 0x93943b4d, 2 | BRF_GRA },		  // Tile data

	{ "a0700.l",       0x400000, 0x26a9ae9c, 3 | BRF_GRA },		  // Sprite Color Data
	...
	{ "b0700.l",       0x400000, 0xaf096904, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
...
static struct BurnRomInfo raf102jRomDesc[] = {
	{ "v102.u4",       0x080000, 0xa65eda9f, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo kovRomDesc[] = {
	{ "p0600.117",     0x400000, 0xc4d19fe6, 1 | BRF_ESS | BRF_PRG }, // 68K Code
	...
	{ "b0600.rom",     0x800000, 0x7d3cd059, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
...
static struct BurnRomInfo kov115RomDesc[] = {
	{ "p0600.115",     0x400000, 0x527a2924, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo kovjRomDesc[] = {
	{ "sav111.u4",     0x080000, 0xae2f1b4e, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo kovplusRomDesc[] = {
	{ "p0600.119",     0x400000, 0xe4b0875d, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo kovplusaRomDesc[] = {
	{ "v119.u3",       0x080000, 0x6750388f, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo kovshRomDesc[] = {
	{ "p0600.322",		  0x400000, 0x7c78e5f3, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0600.320",		  0x400000, 0x164b3c94, 2 | BRF_GRA },		 // Tile data
...
static struct BurnRomInfo puzzli2RomDesc[] = {
	...
	{ "t0900.u9",	  	  0x200000, 0x70615611, 2 | BRF_GRA },		 // Tile data

	{ "a0900.u3",	  	  0x400000, 0x14911251, 3 | BRF_GRA },		 // Sprite Color Data

	{ "b0900.u4",	  	  0x200000, 0x6f0638b6, 4 | BRF_GRA },		 // Sprite Masks & Color Indexes

	{ "m0900.u2",	  	  0x400000, 0x9ea7af2e, 5 | BRF_SND },		 // Samples
};
...
// Martial Masters / Xing Yi (USA, V104)
...
struct BurnDriver BurnDrvKov2 = {
	"kov2", NULL, "pgm", "2000",
	"Knights of Valour 2 (V100)\0", NULL, "IGS", "PGM",
...
static struct BurnRomInfo dmnfrntaRomDesc[] = {
	{ "v105_16m.u5",  	  0x200000, 0xbda083bd, 1 | BRF_ESS | BRF_PRG }, // 68K Code
...
static struct BurnRomInfo pgmdemoRomDesc[] = {
	{ "p0103.rom",     0x200000, 0xd3f6ec45, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0100.rom",     0x400000, 0x0596a59a, 2 | BRF_GRA },		  // Tile data

	{ "a0100.rom",     0x400000, 0x5d0e8fa1, 3 | BRF_GRA },		  // Sprite Color Data

	{ "b0100.rom",     0x400000, 0x15dd191f, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes

	{ "m0100.rom",     0x200000, 0x8d89877e, 5 | BRF_SND },		  // Samples
};
...
static struct BurnRomInfo pgmfrogRomDesc[] = {
	{ "p0103.rom",     0x200000, 0xcdec9e8d, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0100.rom",     0x400000, 0x8f58b6d8, 2 | BRF_GRA },		  // Tile data

	{ "a0100.rom",     0x400000, 0xdc1eafe6, 3 | BRF_GRA },		  // Sprite Color Data

	{ "b0100.rom",     0x400000, 0x3d44b66f, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes

	{ "m0100.rom",     0x200000, 0x05e2f761, 5 | BRF_SND },		  // Samples
};
...
static struct BurnRomInfo pgemeniRomDesc[] = {
	{ "p0103.rom",     0x200000, 0x6cafa56b, 1 | BRF_ESS | BRF_PRG }, // 68K Code

	{ "t0100.rom",     0x400000, 0x42b979dd, 2 | BRF_GRA },		  // Tile data

	{ "a0100.rom",     0x400000, 0x105d7cee, 3 | BRF_GRA },		  // Sprite Color Data

	{ "b0100.rom",     0x400000, 0xb4127373, 4 | BRF_GRA },		  // Sprite Masks & Color Indexes
